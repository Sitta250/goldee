    ...
    >
      ...
      <ul className="space-y-2 leading-relaxed list-none">
        ...
        <li>
          ...
          ระบบตรวจสอบราคาอัตโนมัติประมาณทุก 5 นาทีในช่วงประกาศ (โดยประมาณ 09:00–18:30 น. เวลาไทย)
          นอกช่วงนี้แสดงราคาล่าสุดจากตลาด ในช่วงประกาศราคาที่แสดงอาจล่าช้าจากแหล่งจริงได้ไม่เกินประมาณ 5 นาที
        </li>
        <li>
