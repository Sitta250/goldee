...
export const metadata: Metadata = {
  ...
  description:
    'ราคาทองคำวันนี้ ทองคำแท่งและทองรูปพรรณ ตรวจสอบราคาในช่วงประกาศ (ประมาณ 09:00–18:30 น. ไทย) พร้อมกราฟและเครื่องคิดเลขทอง',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'ราคาทองคำวันนี้ ทองคำแท่งและทองรูปพรรณ ตรวจสอบราคาในช่วงประกาศ (ประมาณ 09:00–18:30 น. ไทย)',
    images: [{
      url:    '/og-image.png',
      width:  1200,
      height: 630,
