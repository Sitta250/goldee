...
async function main() {
  ...
  await db.siteSettings.create({
    data: {
      siteName:          'Goldee',
      siteDescription:   'ราคาทองคำวันนี้ ทองคำแท่งและทองรูปพรรณ ตรวจสอบราคาทุก 5 นาที',
      defaultCurrency:   'THB',
  ...
  const faqItems = [
    {
      ...
      answer:    'ราคาทองที่แสดงบนเว็บไซต์นี้อ้างอิงจากราคาประกาศของสมาคมค้าทองคำ (YGTA) ซึ่งเป็นมาตรฐานที่ร้านทองในประเทศไทยส่วนใหญ่ใช้อ้างอิง ระบบตรวจสอบราคาทุก 5 นาที และแสดงราคาล่าสุดทันทีเมื่อมีการประกาศใหม่',
      sortOrder: 1,
    },
    {
