...
async function main() {
  ...
  await db.siteSettings.create({
    data: {
      siteName:          'Goldee',
      siteDescription:   'ราคาทองคำวันนี้ ทองคำแท่งและทองรูปพรรณ ตรวจสอบราคาในช่วงประกาศ (ประมาณ 09:00–18:30 น. ไทย)',
      defaultCurrency:   'THB',
  ...
  const faqItems = [
    {
      ...
      answer:    'ราคาทองที่แสดงบนเว็บไซต์นี้อ้างอิงจากราคาประกาศของสมาคมค้าทองคำ (YGTA) ซึ่งเป็นมาตรฐานที่ร้านทองในประเทศไทยส่วนใหญ่ใช้อ้างอิง ระบบตรวจสอบราคาประมาณทุก 5 นาทีในช่วงประกาศ (โดยประมาณ 09:00–18:30 น. เวลาไทย) และแสดงราคาล่าสุดเมื่อมีการประกาศใหม่',
      sortOrder: 1,
    },
    {
